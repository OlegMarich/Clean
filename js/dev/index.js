  ...
  if (document.querySelector(".example__slider")) {
    new Swiper(".example__slider", {
      ...
      */
      // Пагінація
      pagination: {
        el: ".content-example__swiper-pagination",
        clickable: true,
        dynamicBullets: true
      },
      // Скроллбар
      ...
      */
      // Кнопки "вліво/вправо"
      navigation: {
        prevEl: ".example__swiper-button-prev",
        nextEl: ".example__swiper-button-next"
      },
      /*
      // Брейкпоінти
      breakpoints: {
  ...
  beforeAfterItemInit(beforeAfter) {
    ...
    function beforeAfterDrag(e) {
      ...
      if (isMobile.any()) {
        ...
        document.addEventListener("touchend", function(e2) {
